                    ...
                    <div class={styles.lama}>
                        {showEyes.value && (
                            <div document:onMouseMove$={(event) => {
                                ...
                                pupilLeft.style.transform = `translateX(${eyeAreaRadius - pupilAreaRadius + "px"}) rotate(${(angle) + "deg"})`;
                                pupilLeft.style.transformOrigin = `${pupilAreaRadius + "px"} center`;

                                pupilRight.style.transform = `translateX(${eyeAreaRadius - pupilAreaRadius + "px"}) rotate(${(angle) + "deg"})`;
                                pupilRight.style.transformOrigin = `${pupilAreaRadius + "px"} center`;
                            }}>
